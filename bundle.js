var rpg = (function (createGraph, ngraphPath) {
    ...
    class world_map {
		...
		`;
            ...
            plus.onclick = () => {
                world_map.scalar += 0.5;
                world_map.pos = pts.mult(world_map.pos, 1.5);
                this.scale();
                this.reposition();
            };
            minus.onclick = () => {
                world_map.pos = pts.mult(world_map.pos, 0.5);
                world_map.scalar -= 0.5;
                this.scale();
                this.reposition();
            };
        ...
        scale() {
            console.log('scalar', world_map.scalar);
            //this.world_map_scaler.style.zoom = world_map.scalar;
        }
        add_svg() {
